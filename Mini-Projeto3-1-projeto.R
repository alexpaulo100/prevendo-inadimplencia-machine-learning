...
setwd("C:/Users/padrao/OneDrive/Documentos/Curso-Power-BI-DSA/Cap15/dados")
getwd()
...
dados_clientes <- read.csv("C:/Users/padrao/OneDrive/Documentos/Curso-Power-BI-DSA/Cap15/dados/dataset")
